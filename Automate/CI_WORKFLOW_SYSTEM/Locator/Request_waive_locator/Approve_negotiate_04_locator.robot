...
*** Variables ***
# Inquiry
${dropdown_04_inbox_req_type_locator}      //select[@id="ctl00_phContents_ASPxRoundPanel1_D_request_type"]
${txt_04_inbox_requester_locator}          //input[@id="ctl00_phContents_ASPxRoundPanel1_E_requester"]
${txt_04_inbox_request_no_locator}         //input[@id="ctl00_phContents_ASPxRoundPanel1_E_request_no"]
${txt_04_inbox_cust_id_locator}            //input[@id="ctl00_phContents_ASPxRoundPanel1_E_id"]
${txt_04_inbox_contract_locator}           //input[@id="ctl00_phContents_ASPxRoundPanel1_E_contract"]
${btn_04_inbox_search_locator}             //input[@id="ctl00_btnSearch"]


# Inquiry - title table
${txt_title_table_04_inbox_format_locator}                 //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//th[@scope="col" and text()="***replace***"]
${txt_title_table_req_type_04_inbox_format_locator}        //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//th[@scope="col" and text()="Request Type"][1]
${txt_title_table_req_type2_04_inbox_format_locator}       //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//th[@scope="col" and text()="Request Type"][2]
${txt_herf_table_action_04_inbox_locator}                  //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//a[text()="Action"]
${txt_herf_table_view_04_inbox_locator}                    //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//a[text()="View"]


# Inquiry - value
${txt_value_table_req_type_04_inbox_format_locator}        //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//td[contains(text(), "***replace***")]
${txt_value_table_04_inbox_format_locator}                 //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//td[text()="***replace***"]
${txt_value_table_action_04_inbox_format_locator}          //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//a[text()="***replace***"]
${txt_value_sender_inquiry_locator}                        //table//tr[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView_DXDataRow0"]/td[2]
${txt_value_appr_user_04_inbox_locator}                    //table//tr[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView_DXDataRow0"]/td[14]
...
${txt_title_04_approve_negotiate_req_no_locator}          //font[text()="Request No."]
${txt_title_04_approve_negotiate_requester_locator}       //font[text()="Requester"] 
${txt_title_04_approve_negotiate_req_date_locator}        //font[text()="Request Date"]
...
${txt_title_04_approve_negotiate_cont_no_locator}         //font[text()="Contract No"]
${txt_title_approve_negotiate_status_date_locator}        //td[@align and contains(text(), "Status Date")]
${txt_title_04_approve_negotiate_cust_name_locator}       //font[text()="Customer Name"] 
...
${txt_title_04_approve_negotiate_team_locator}            //font[text()="Team"]
${txt_title_approve_negotiate_age_locator}                //td[@align and contains(text(), "Age")]
${txt_title_04_approve_negotiate_od_status_locator}       //font[text()="OD Status"]
...
${txt_title_04_approve_negotiate_biz_locator}             //font[text()="Business"]
...
${txt_title_04_approve_negotiate_req_time_locator}        //font[text()="Request Times"]
...
${txt_title_04_approve_negotiate_reason_locator}               //font[text()="Reason"]
${txt_title_04_approve_negotiate_reason_note_locator}          //font[text()="Reason Note"]
${txt_title_approve_negotiate_send_to_locator}                 //span[@id="ctl00_phContents_ASPxRoundPanel1_L_send_to"]
${txt_title_04_approve_negotiate_rej_reason_locator}           //font[text()="Reject Reason"]
${txt_title_04_approve_negotiate_rej_note_locator}             //font[contains(text(), "Reject") and contains(text(), "Note")]
${txt_title_04_approve_negotiate_note_locator}                 //font[text()="Note"]
