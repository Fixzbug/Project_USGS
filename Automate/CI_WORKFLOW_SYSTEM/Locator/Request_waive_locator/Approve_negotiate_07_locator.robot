...
*** Variables ***
# Inquiry
${dropdown_07_inbox_req_type_locator}      //select[@id="ctl00_phContents_ASPxRoundPanel1_D_request_type"]
${txt_07_inbox_requester_locator}          //input[@id="ctl00_phContents_ASPxRoundPanel1_E_requester"]
${txt_07_inbox_request_no_locator}         //input[@id="ctl00_phContents_ASPxRoundPanel1_E_request_no"]
${txt_07_inbox_cust_id_locator}            //input[@id="ctl00_phContents_ASPxRoundPanel1_E_id"]
${txt_07_inbox_contract_locator}           //input[@id="ctl00_phContents_ASPxRoundPanel1_E_contract"]
${btn_07_inbox_search_locator}             //input[@id="ctl00_btnSearch"]


# Inquiry - title table
${txt_title_table_07_inbox_format_locator}                 //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//th[@scope="col" and text()="***replace***"]
${txt_title_table_req_type_07_inbox_format_locator}        //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//th[@scope="col" and text()="Request Type"][1]
${txt_title_table_req_type2_07_inbox_format_locator}       //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//th[@scope="col" and text()="Request Type"][2]
${txt_herf_table_action_07_inbox_locator}                  //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//a[text()="Action"]
${txt_herf_table_view_07_inbox_locator}                    //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//a[text()="View"]


# Inquiry - value
${txt_value_table_req_type_07_inbox_format_locator}        //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//td[contains(text(), "***replace***")]
${txt_value_table_07_inbox_format_locator}                 //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//td[text()="***replace***"]
${txt_value_table_action_07_inbox_format_locator}          //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//a[text()="***replace***"]
${txt_value_sender_inquiry_locator}                        //table//tr[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView_DXDataRow0"]/td[2]
${txt_value_appr_user_07_inbox_locator}                    //table//tr[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView_DXDataRow0"]/td[14]
