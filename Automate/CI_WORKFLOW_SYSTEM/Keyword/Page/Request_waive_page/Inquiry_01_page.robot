...
SET FORMAT DATA TYPE 01
    ...
    FOR  ${index}  IN RANGE    ${start_at_case}    ${countrow} + 1  
        ...
        IF  ${Request_No} != 'none' and ${State} == 'Approve'
            ...
            # verify title
            # Inquiry_01_feature.SET FEATURE - TYPE - 01 - VERIFY - TITLE - PAGE INQUIRY

            # verify data
            Inquiry_01_feature.SET FEATURE - TYPE - 01 - VERIFY - DATA - PAGE INQUIRY    # อย่าลืม จำว่า สิ้นสุดที่ user level ไหนละเอาคนนั้นมาเช็คเพื่อ ตรวสอบตอนจบด้วย
            ...
            IF  ${status_}
                ...
                Common_feature.SET - DATA TO EXCEL    excel_name=${Excel_name}    sheet_name=${type_01}    row=${Rows}    column=10    data=Finished    # Rows global ,colum fix ,data global
            ...
            ELSE
                ...
                # เขียนข้อมูล row, column -> Request
                Common_feature.SET - DATA TO EXCEL    excel_name=${Excel_name}    sheet_name=${type_01}    row=${Rows}    column=10    data=Pending    # Rows global ,colum fix ,data global
...
# verify table
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - REQUEST TYPE
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - REQUEST TYPES
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[1]]    # request type PAGE INQUIRY title exists   

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - REQUEST DESC
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - CUSTOMER ID
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - TEAM
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[17]]          

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - REASON
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[18]]           

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - REQ NO
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[27]]    

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - SENDER
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - SEND DATE
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - CONTRACT NO
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[30]]    # contract no. have - / 3969-001-000255494

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - NAME
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[31]]     

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - REQUEST BY
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - REQUEST AMT
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[33]]  

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - APPROVE USER
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[34]]    # approve user PAGE INQUIRY and inquiry

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - STATUS
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[35]]        

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TITLE] - STEP 1 - BIZ
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data_label}[${keys_group_data_label}[40]]  


    
# verify table
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - REQUEST TYPE
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - TEAM
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data}[${keys_group_data_label}[17]]    # move focus     

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - REASON
    ${list}=    Common_keyword.CONVERT DATA SPLIT AND STRIP BY OPTION    ${group_data}[${keys_group_data_label}[18]]    option=:
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${list}[0]            

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - REQ NO
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - SENDER
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - SEND DATE
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - CONTRACT NO
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - NAME
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - REQUEST BY
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - REQUEST AMT
...
PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - APPROVE USER
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data}[${keys_group_data_label}[25]]    # add new  P2106010

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - STATUS
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data}[${keys_group_data_label}[41]]    # data approve status finished  

PAGE INQUIRY - TYPE 01 - [VERIFY] - [TEXT] - STEP 1 - BIZ
    Common_keyword.GET TEXT VERIFY DATA AND PAGE REPLACE LOCATOR OPTION AND EQUAL STRINGS    ${txt_td_replace}    ${group_data}[${keys_group_data_label}[40]]    
