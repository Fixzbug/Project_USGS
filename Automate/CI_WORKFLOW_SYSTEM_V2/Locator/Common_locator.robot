...
${txt_option_replace}                   //option[@title='***replace***'] 
${txt_all_replace}                      //*[contains(text(),'***replace***')]
...
${txt_req_error}                        //span[@id='ctl00_phContents_ASPxRoundPanel1_lblMsg']
...
${btn_submit_locator}             //input[@id="ctl00_phContents_ASPxRoundPanel1_B_submit"]
...
${txt_value_table_inq_status_finish_locator}    //table[@id="ctl00_phContents_ASPxRoundPanel1_GD_DataView"]//td[text()="Finished"]